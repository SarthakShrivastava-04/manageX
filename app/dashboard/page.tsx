...
import { Search, Loader2, AlertCircle, UsersIcon } from "lucide-react"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-black dark:text-white">User Management</h1>
          <p className="text-lg text-gray-600 dark:text-gray-400 mt-2">Manage and view all users in your system</p>
        </div>
          ...
          >
            <Card className="card-hover border-2 rounded-2xl">
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-xl font-bold text-black dark:text-white">{user.name}</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">City</p>
      ...
      {filteredUsers.length === 0 && searchTerm && (
        <div className="text-center py-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">No users found matching your search.</p>
        </div>
      )}
    </motion.div>
  )
